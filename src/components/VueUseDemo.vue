  ...
  <div class="p-8">
    ...
    <div class="mb-8 p-4 border rounded-lg">
      ...
      <div class="h-40 bg-gray-100 rounded relative" ref="mouseArea">
        <div 
          class="w-4 h-4 bg-blue-500 rounded-full absolute transform -translate-x-1/2 -translate-y-1/2"
          :style="{ left: `${x - 150}px`, top: `${y - 230}px` }"
        ></div>
...
import { ref } from 'vue'
import { useMouse, useLocalStorage, useWindowSize, useDebounce } from '@vueuse/core'
